...
namespace Elemancy
{
    ...
    public class EnemyBoss : IEnemy, ISprite
    {
        ...
        {
            if (enemy == 1) Health = 100;
            if (enemy == 2) Health = 150;
            if (enemy == 3) Health = 200;
        }
        ...
        public void Draw(SpriteBatch spriteBatch, GameTime gameTime)
        {
            if (enemyTexture != null)
            {
                ...
                {
                    spriteBatch.Draw(enemyTexture, Position, null, Color.White, 0.0f, new Vector2(0, 0), new Vector2(1.2f, 1.2f), SpriteEffects.None, 0.0f);
